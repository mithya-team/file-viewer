# page-navigate-settled Specification

## Purpose

Programmatic page-navigation settle signal for citation hosts and custom chrome across PDF, multi-page TIFF, and PPTX.
