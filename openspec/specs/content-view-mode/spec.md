# content-view-mode Specification

## Purpose

Shell-owned Preview | Source mode for markdown and HTML: chrome API controls, default chrome UI, and routing to `TextRenderer` for source.
