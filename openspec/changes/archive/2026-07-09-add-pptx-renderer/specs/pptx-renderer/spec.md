...
Content-driven PPTX/POTX detection and internal multi-slide static preview via pinned Pagus (`@pagus-kit/core@0.1.1`, `@pagus-kit/renderer@0.1.1`): parse once per buffered blob, lazy per-slide SVG render, PDF-like scroll/zoom chrome.
