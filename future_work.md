...
- Demo fixtures are already present in `apps/demo/public/sample-files` for `txt`, `csv`, `jpg`, `pdf`, `docx`, `dotx`, and `xlsx`.
...
- Expand verification: more `FileViewer` integration tests, renderer smoke tests, demo-level checks.
